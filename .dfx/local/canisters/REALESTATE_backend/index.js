...
import { idlFactory } from './REALESTATE_backend.did.js';
export { idlFactory } from './REALESTATE_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REALESTATE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./REALESTATE_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the REALESTATE_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./REALESTATE_backend.did.js")._SERVICE>}
 */
export const REALESTATE_backend = createActor(canisterId);

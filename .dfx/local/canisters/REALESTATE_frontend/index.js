...
import { idlFactory } from './REALESTATE_frontend.did.js';
export { idlFactory } from './REALESTATE_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REALESTATE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./REALESTATE_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the REALESTATE_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./REALESTATE_frontend.did.js")._SERVICE>}
 */
export const REALESTATE_frontend = createActor(canisterId);

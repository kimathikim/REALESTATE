...
#[ic_cdk_macros::update(name = "add_property")]
#[candid::candid_method(update, rename = "add_property")]
async fn _cdk_user_defined_add_property(
    ...
    let vm = &interpreter.vm;
    let params = (
        _cdk_user_defined_id.try_into_vm_value(vm).unwrap_or_trap(),
    ...
    call_global_python_function("add_property", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "update_property_valuation")]
#[candid::candid_method(update, rename = "update_property_valuation")]
async fn _cdk_user_defined_update_property_valuation(
    _cdk_user_defined_property_id: String,
    _cdk_user_defined_new_value: candid::Nat,
) -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (
        _cdk_user_defined_property_id
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
        _cdk_user_defined_new_value
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
    );
    call_global_python_function("update_property_valuation", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "update_property_status")]
#[candid::candid_method(update, rename = "update_property_status")]
async fn _cdk_user_defined_update_property_status(
    _cdk_user_defined_property_id: String,
    _cdk_user_defined_status: bool,
) -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (
        _cdk_user_defined_property_id
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
        _cdk_user_defined_status
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
    );
    call_global_python_function("update_property_status", params)
        .await
        .unwrap_or_trap()
}
...
#[ic_cdk_macros::update(name = "enable_mfa")]
#[candid::candid_method(update, rename = "enable_mfa")]
async fn _cdk_user_defined_enable_mfa() -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = ();
    call_global_python_function("enable_mfa", params)
        .await
        .unwrap_or_trap()
}
